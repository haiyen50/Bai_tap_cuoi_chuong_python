...
if __name__ == "__main__":
    ...
    # Thêm một số phần tử nữa
    stack.push(7.3)
    stack.push(9.6)

    # In lại nội dung và số phần tử của ngăn xếp
    stack.print()
    print("Số phần tử trong ngăn xếp:", stack.count())

    # Lấy một phần tử ra và kiểm tra lại
    stack.pop()
    print("Số phần tử trong ngăn xếp sau khi pop:", stack.count())
